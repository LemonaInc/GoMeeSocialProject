...
class LoginViewController: UIViewController, AKFViewControllerDelegate{
    ...
    func prepareLoginViewController(_ loginViewController: AKFViewController) {
        ...
        theme.headerBackgroundColor = UIColor(red:0.21, green:0.77, blue:0.98, alpha:1)
        theme.headerTextColor = UIColor(red: 1, green: 1, blue: 1, alpha: 1)
        theme.iconColor = UIColor(red: 0.325, green: 0.557, blue: 1, alpha: 1)
        theme.inputTextColor = UIColor(red:0.21, green:0.77, blue:0.98, alpha:1.00)
        theme.statusBarStyle = .default
        theme.textColor = UIColor(white: 0.3, alpha: 1.0)
        theme.titleColor = UIColor(red: 0.247, green: 0.247, blue: 0.247, alpha: 1)
        theme.buttonBackgroundColor = UIColor(red:0.21, green:0.77, blue:0.98, alpha:1) 
